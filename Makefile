...
MPCGOBJ_ = \
  ...
  $(B)/$(MISSIONPACK)/cgame/cg_qlone.o \
  $(B)/$(MISSIONPACK)/cgame/cg_freeze.o \
  \
...
Q3GOBJ_ = \
  ...
  $(B)/$(BASEGAME)/game/bg_qlone.o \
  $(B)/$(BASEGAME)/game/g_qlone.o \
...
MPGOBJ_ = \
  ...
  $(B)/$(MISSIONPACK)/game/bg_qlone.o \
  $(B)/$(MISSIONPACK)/game/g_qlone.o \
