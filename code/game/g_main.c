...
vmCvar_t	g_freezeTagVersion;
vmCvar_t	g_instaGib;
vmCvar_t	g_noSelfDamage;
vmCvar_t	g_ammolimit;
vmCvar_t	g_specLock;
vmCvar_t	g_removeAllItems;
vmCvar_t	g_fastRGReload;
...
static cvarTable_t		gameCvarTable[] = {
	...
	//qlone - server options
	{ &g_freezeTag, "freezeTag", "0", CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qtrue },
	{ &g_freezeTagVersion, "freezeTagVersion", "1.52", CVAR_ROM | CVAR_SERVERINFO, 0, qfalse },
	{ &g_instaGib, "instaGib", "0", CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qtrue },
	{ &g_noSelfDamage, "g_noSelfDamage", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &g_ammolimit, "ammolimit", "0", 0, 0, qfalse },
	{ &g_specLock, "g_specLock", "1", CVAR_ARCHIVE, 0, qtrue },
	{ &g_removeAllItems, "g_removeAllItems", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &g_fastRGReload, "g_fastRGReload", "0", CVAR_ARCHIVE, 0, qtrue },
