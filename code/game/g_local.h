...
//unlagged - server options
//qlone - server options
extern	vmCvar_t	g_freezeTag;	// toggle FreezeTag gameplay
extern	vmCvar_t	g_freezeTagVersion;
extern	vmCvar_t	g_instaGib;	// toggle instaGib gameplay
extern	vmCvar_t	g_noSelfDamage;	// <0|1|2> (self damages, no, no+armor)
extern	vmCvar_t	g_ammolimit;	// as weaponlimit but for ammo
extern	vmCvar_t	g_specLock;	// limit spectator to teammates
extern	vmCvar_t	g_removeAllItems;
extern	vmCvar_t	g_fastRGReload;
extern	vmCvar_t	g_fastWeaponSwitch;
extern	vmCvar_t	g_railJump;
extern	vmCvar_t	g_startHealth;
// Quantity of ammo at spawn
extern	vmCvar_t	g_startAmmoMG;	// Machinegun
extern	vmCvar_t	g_startAmmoSG;	// Shotgun
extern	vmCvar_t	g_startAmmoGL;	// Grenade launcher
extern	vmCvar_t	g_startAmmoRL;	// Rocket launcher
extern	vmCvar_t	g_startAmmoLG;	// Lightning gun
extern	vmCvar_t	g_startAmmoRG;	// Railgun
extern	vmCvar_t	g_startAmmoPG;	// Plasma gun
extern	vmCvar_t	g_startAmmoBFG;	// BFG10K
#ifdef MISSIONPACK
extern	vmCvar_t	g_startAmmoNG;	// Nailgun
extern	vmCvar_t	g_startAmmoPL;	// Prox launcher
extern	vmCvar_t	g_startAmmoCG;	// Chaingun
#endif
//qlone
//freeze
